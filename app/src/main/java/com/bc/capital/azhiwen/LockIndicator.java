...
public class LockIndicator extends View {
    ...
    public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        patternNoraml = getResources().getDrawable(R.drawable.lock_pattern_node_normal);//小图标默认颜色
        patternPressed = getResources().getDrawable(R.drawable.lock_pattern_node_pressed);//小图标选中颜色
