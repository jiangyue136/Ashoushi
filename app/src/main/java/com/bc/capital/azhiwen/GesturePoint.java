    ...
    public void setPointState(int state) {
        ...
        switch (state) {
            case Constants.POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.drawable.gesture_node_normal);//背景色
                break;
            case Constants.POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.drawable.gesture_node_pressed);//选中色
                break;
            case Constants.POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.drawable.gesture_node_wrong);//错误色
                break;
            default:
                break;
        }
